...
var AE = require ('@aeternity/aepp-sdk')
var keypair = {}
...
exports.getGameBalance = function (gameAddress, userAddress) {
  return new Promise((resolve) => {
    ...
    AE.Universal({
      ...
      clientU.getContractInstance(gameContract, {contractAddress: gameAddress}).then((contResp) => {
        contractU = contResp
        contractU.methods.balance_of(userAddress).then((deployResp) => {
          resolve(deployResp)
        })
      })
    })
...
// Call static method
const callStatic = function (contract, funcName, params) {
...
const call = function (contract, funcName, params, address) {
  return new Promise((resolve) => {
...
// Deploy contract
const deploy = function (contract, funcName, params) {
  return new Promise((resolve) => {
    var keypair = {}
    keypair.secretKey = '165e6b751ef44d0cd2b6447fc0d456605be27c207fcd8beac2982b3c5bc8267afd111407359c7302f710fcb92a1128892434048ba50dc8eabb5c916acda86cd7'
    keypair.publicKey = 'ak_2vTFUL1Yz4qSBd7TDzxaDjZE7st2JpyLRa7P54coMA2UrnqLGX'
